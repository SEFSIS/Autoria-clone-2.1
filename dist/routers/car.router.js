...
router.post("/", auth_middleware_1.authMiddleware.checkAccessToken, auth_middleware_1.authMiddleware.checkUserOnly, car_middleware_1.carMiddleware.isCarBodyValid(car_validator_1.CarValidator.create), car_controller_1.carController.createCar);
